...
This project was started from scratch, and is currently present in ROM on the SM8650, and slated to be included with many more upcoming mobile, automotive, and IoT Qualcomm chipsets.
